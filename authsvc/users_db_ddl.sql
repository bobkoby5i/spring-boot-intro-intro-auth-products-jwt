...
drop table ASSIGN_USER_TO_ROLE;
drop table ASSIGN_PERMISSION_TO_ROLE;
drop table ROLES;
drop table USERS;
...
create unique index idx_user_email on users (EMAIL_ID);
...
-- guest (VIEW)
INSERT INTO ASSIGN_PERMISSION_TO_ROLE (PERMISSION_ID, ROLE_ID) VALUES (5, 3);
...
INSERT INTO ASSIGN_USER_TO_ROLE (USER_ID, ROLE_ID) VALUES (3, 3); --alice,GUEST
